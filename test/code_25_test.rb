...
class Code25Test < Barby::TestCase
  ...
  it 'should raise on encoding methods that include data encoding if not valid' do
    @code.data = 'abc'
    -> { @code.encoding }.must_raise ArgumentError
    -> { @code.data_encoding }.must_raise ArgumentError
    -> { @code.data_encoding_with_checksum }.must_raise ArgumentError
    -> { @code.digit_encodings }.must_raise ArgumentError
    -> { @code.digit_encodings_with_checksum }.must_raise ArgumentError
  end
